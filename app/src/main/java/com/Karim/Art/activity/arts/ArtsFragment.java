...
import com.Karim.Art.core.ArtistoService;
import com.Karim.Art.core.ResponseListener;
import com.Karim.Art.database.ArtsContract;
import com.Karim.Art.database.ArtsOpenHelper;
import com.Karim.Art.dto.ArtworkResponse;
import com.Karim.Art.event.ArtSelectedEvent;
...
import com.Karim.Art.utils.Utils;
...
public class ArtsFragment extends BaseArtFragment implements ResponseListener<ArtworkResponse>, ArtsAdapter.Callbacks{
    ...
    private void addNativeAppInstallAds() {
        ...
        for (int i = 0; i <= mArts.size(); i += ITEMS_PER_AD) {
            final NativeAppInstallAdView adView = new NativeAppInstallAdView(ArtistoApplication.getInstance());
            mArts.add(i, adView);
        }
    }
